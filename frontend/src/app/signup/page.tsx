...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f2f2f2] flex items-center justify-center px-4">
      <div
        className="
          bg-white p-10 rounded-[18px] text-center w-full max-w-[350px]
          shadow-[8px_8px_16px_rgba(0,0,0,0.15),_-8px_-8px_16px_rgba(255,255,255,0.9)]
        "
      >
        <div className="flex justify-center mb-6">
        ...
        <h2
          className="
            font-[Instrument_Serif] text-[24px] leading-[100%] tracking-[0.04em]
            text-black mb-12
          "
        >
          Welcome to Vibeboard
        ...
        <button
          ...
          className="
            w-full max-w-[290px] mx-auto px-4 py-3 rounded-xl
            flex items-center justify-center gap-3
            text-black font-[Instrument_Serif] text-[20px]
